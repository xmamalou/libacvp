...
static ACVP_RESULT acvp_build_ascon_cxof128_cap(ACVP_CTX *ctx,
    ...
    json_object_set_number(cstr_obj, "min", cap->cstr_len.min);
    json_object_set_number(cstr_obj, "max", cap->cstr_len.max);
    json_object_set_number(cstr_obj, "increment", cap->cstr_len.increment);
